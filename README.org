...
- =apps/macos/= :: SwiftUI app, two targets sharing one codebase (=EmacsAgendaViewerMac= / =EmacsAgendaViewer=). Sonoma-vibrancy design refreshed in v0.3.0, edit-mode rework + outline breadcrumb in v0.3.1; see the section below.
